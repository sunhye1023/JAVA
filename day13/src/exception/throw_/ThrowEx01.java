...
public class ThrowEx01 {
	...
	public static void main(String[] args) {	
		...
		try {			
			...
			//System.out.println(e.getMessage()); //예외 발생 시 전달 할 예외 메시지를 얻어오는 기능
			e.printStackTrace(); //printStackTrace() 예외의 경로를 추적하는 메시지를 출력해줍니다(예외 원인을 찾을 때 매번 사용됩니다)
		}
	...
	public static int calc(int n) throws Exception {
		...
		if(n<=0) {
			throw new Exception("0보다 큰 값을 입력해야합니다");
		}
