...
public class BufferedReader_UTF8 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 문서를 읽어들일 때, 인코딩형식이 다르면 한글이 깨지는 현상이 발생합니다
		 * bufferedReader를 통해서 인코딩형식을 지정한 후에 가져오는 방법
		 */
		...
		try {
			...
			*/
			...
			br = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\course\\java\\file\\text3.txt"), "ECU-KR"));
