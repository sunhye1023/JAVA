...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(cal.sub(30));
		System.out.println(cal.mulit(2));
		System.out.println(cal.div(4));
		System.out.println(cal.circle(3));
		System.out.println("--------------");
		Computer com = new Computer();
		System.out.println(com.add(50));
		System.out.println(com.sub(30));
		System.out.println(com.mulit(2));
		System.out.println(com.div(4));
		System.out.println(com.circle(2));
		System.out.println(com.rect(4));
		System.out.println(com.rect(4.2, 6.3));
		System.out.println(com.rect(3.1,4.5,5.9));
